...
//              smearedPos[2] = hitvec.z() ;
      ...
      layerID = ILDDetectorIDs::DetID::VXD * ILDDetectorIDs::DetID::Factor + layerNumber ; 
      ...
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>() = new ILDPlanarHitExt::PlanarHitExtStruct ;

      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->u  = u+rPhiSmear ;
      //      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->u  = u ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->du = _pointResoRPhi ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->v  = hitvec.z()+zSmear ;
      //      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->v  = hitvec.z() ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->dv = _pointResoZ ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->ladder_r = ladder_r ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->ladder_phi = ladderPhi ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->ladder_offset = sensitive_offset ;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->ladder_number = ladderNumber;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->ladder_width  = sensitive_width;
      trkHit->ext<ILDPlanarHitExt::PlanarHitExt>()->ladder_length = sensitive_length;
